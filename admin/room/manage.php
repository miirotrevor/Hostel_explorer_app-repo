...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?> Hostel</h3>
	</div>
	<div class="card-body">
		<form action="" id="room-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
			<div class="form-group">
				<label for="room" class="control-label">Hostel</label>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="room-form">Save</button>
